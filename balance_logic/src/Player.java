public class Player
{
	...
	public void updateRan(int type, int answerIndex)
	{
		...
		} else
		{
			...
			/*
			 * 25
			 * Vacation : lowers grade by 15, raises happiness by 15, raises
			 * energy
			 * by 15
			 ...
			 * Work : raises cash by $100, lowers grade by 10, lowers energy by
			 * 15
			 */
			case 30:
				if (answerIndex == 0)
	...
	public void updateDepend(int type, int answerIndex)
	{
		...
		} else
		{
			...
			/*
			 * 1
			 * Apply : if grade >= 85, raise happiness by 10, raise grade by 5;
			 * else
