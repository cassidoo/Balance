public class Player
{
	...
	public Player(double money, int happiness, int grade, int ener, int time,
			int loan)
	{
	...
	public void updateFirst(int type, int answerIndex)
	{
		...
		/*
		 * 1
		 * Car : $1000, raises happiness by 10, increases energy by 5, lowers
		 * money by $10/week
		 ...
		 * Off-campus Restaurant Server : $8.50/hour, decreases grade by 10,
		 * /week
	...
	public void updateRan(int type, int answerIndex)
	{
		 ...
		 * Stay up all night to study : raises grade by 10, lowers energy by 10,
		...
		/*
		 * 2
		 * Go to Doctor : $100, lowers grade by 5, raises energy by 5, raises
		 * happiness by 5
		 * Stay sick : lowers grade by 5, lowers energy by 5, lowers happiness
		 * by 5
		 */
		case 2:
			if (answerIndex == 0)
		 ...
		 * happiness by 15
		 * Stay in and study : raises grade by 10, raises energy by 10, lowers
		 * happiness by 5
		 */
		case 3:
			if (answerIndex == 0)
		 ...
		 * happiness by 15
		 * Stay and study all weekend : raises grade by 10, raises energy by 10,
		 ...
		 * Work : raise by $50, lowers grade by 3, lowers energy by 5, lowers
		 * happiness by 3
		 */
		case 9:
			if (answerIndex == 0)
		 ...
		 * Court : lowers cash by $50, lowers grade by 5, lowers happiness by 5,
		 * lowers energy by 5
		 */
		case 11:
			if (answerIndex == 0)
		...
		/*
		 * 12
		 * Party : lowers cash by $50, raises happiness by 10, lowers energy by
		 * 5
		...
		/*
		 * 13
		 * Party : lowers cash by $25, raises happiness by 10, lowers energy by
		 * 5
		 * Skip : lowers happiness by 10
		 */
		case 13:
		...
		/*
		 * 18
		 * Pay : $50, raises grade by 5, raises energy by 5, raises happiness by
		 * 5
		 * Stay : lowers energy by 10, raises grade by 10, lowers happiness by
		 * 10
		 */
		case 18:
			if (answerIndex == 0)
		...
		/*
		 * 21
		 * Doctor : lowers cash by $300, raises energy by 5, raises happiness by
		 * 10
	...
	public void updateDepend(int type, int answerIndex)
	{
		switch (type)
		{
		/*
		 * 0
		 * Apply : if grade >= 90, get $500, raise happiness by 10; else lower
		 * happiness by 10
		...
		/*
		 * 1
		 * Apply : if grade >= 85, raise happiness by 10, raise grade by 5; else
		...
		/*
		 * 2
		 * Try Out : if energy >= 85 and happiness >= 85, raise happiness by 10;
		...
		/*
		 * 3
		 * Apply : if grade >= 75 and happiness >= 80, raise happiness by 10,
		 * raise grade by 10; else lower happiness by 10
		 * Study : raise grade by 5, lower energy by 5
		 * Message: if true
		...
		/*
		 * 4
		 * Eat : if happiness >= 70, raise happiness by 10, raise cash by $10;
		 * else lower happiness by 10
