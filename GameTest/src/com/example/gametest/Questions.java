...
public class Questions {
	...
	public ArrayList<String> firstQuestions; //5
	public HashMap<Integer, String[]> randAnswers;
	public ArrayList<String> randQuestions; //32
	//dependent questions
	public HashMap<Integer, String[]> dependAnswers;
	public ArrayList<String> dependQuestions; //5
	...
	public Questions()
	{
		...
		String[] arr2 = {"On-campus: Tutor ($7/hour, 3 hours/day)", "Off-campus: Restaurant Server ($9/hour 5 hours/day)"};
